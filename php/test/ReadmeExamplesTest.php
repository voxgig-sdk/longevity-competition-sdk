...
// LongevityCompetition SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LongevityCompetitionSDK::test)
...
{
    private const SDK_CLASS = 'LongevityCompetitionSDK';
    ...
    private const SDK_BASE = 'longevitycompetition_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../longevitycompetition_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
