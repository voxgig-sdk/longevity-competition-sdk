...
class AthleteEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LONGEVITYCOMPETITION_TEST_ATHLETE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function athlete_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LONGEVITYCOMPETITION_TEST_ATHLETE_ENTID");
