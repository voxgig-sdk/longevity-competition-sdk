...
class PhenoAgeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LONGEVITYCOMPETITION_TEST_PHENO_AGE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function pheno_age_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LONGEVITYCOMPETITION_TEST_PHENO_AGE_ENTID");
