...
// LongevityCompetition SDK utility type

class LongevityCompetitionUtility
{
    ...
    public static function copy(LongevityCompetitionUtility $src): LongevityCompetitionUtility
    {
        $u = new LongevityCompetitionUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
