...
// LongevityCompetition SDK timeout feature
...
class LongevityCompetitionTimeoutFeature extends LongevityCompetitionBaseFeature
{
    ...
    private function _with_timeout(LongevityCompetitionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LongevityCompetitionContext $_ctx, float $ms): void
    {
        $client = $this->client;
