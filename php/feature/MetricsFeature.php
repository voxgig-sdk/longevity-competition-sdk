...
// LongevityCompetition SDK metrics feature
...
class LongevityCompetitionMetricsFeature extends LongevityCompetitionBaseFeature
{
    ...
    private function _record(LongevityCompetitionContext $ctx, bool $ok): void
    {
