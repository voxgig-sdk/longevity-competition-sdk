...
// LongevityCompetition SDK idempotency feature
...
class LongevityCompetitionIdempotencyFeature extends LongevityCompetitionBaseFeature
{
    ...
    private function _mutating(LongevityCompetitionContext $ctx): bool
    {
