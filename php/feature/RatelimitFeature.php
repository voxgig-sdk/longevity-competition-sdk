...
// LongevityCompetition SDK ratelimit feature
...
class LongevityCompetitionRatelimitFeature extends LongevityCompetitionBaseFeature
{
    ...
    private function _acquire(LongevityCompetitionContext $ctx): void
    {
    ...
    private function _track(LongevityCompetitionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
