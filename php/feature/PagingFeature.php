...
// LongevityCompetition SDK paging feature
...
class LongevityCompetitionPagingFeature extends LongevityCompetitionBaseFeature
{
    ...
    private function _is_list(LongevityCompetitionContext $ctx): bool
    {
