...
// LongevityCompetition SDK debug feature
...
class LongevityCompetitionDebugFeature extends LongevityCompetitionBaseFeature
{
    ...
    private function _finish(LongevityCompetitionContext $ctx, bool $ok): void
    {
