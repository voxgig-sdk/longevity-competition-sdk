...
// LongevityCompetition SDK utility: result_basic

class LongevityCompetitionResultBasic
{
    public static function call(LongevityCompetitionContext $ctx): ?LongevityCompetitionResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof LongevityCompetitionError) ? $result->err->msg : (string)$result->err;
