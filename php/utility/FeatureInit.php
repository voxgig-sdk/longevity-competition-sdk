...
// LongevityCompetition SDK utility: feature_init

class LongevityCompetitionFeatureInit
{
    public static function call(LongevityCompetitionContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
