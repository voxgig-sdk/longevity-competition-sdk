...
// LongevityCompetition SDK BortzAge entity
...
class BortzAgeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BortzAgeEntity($this->_client, $opts);
    }

    /**
     * @param BortzAge|array $args BortzAge data (assoc-array) to store.
     */
    ...
    /**
     * @return BortzAge|array The current BortzAge data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BortzAge fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BortzAge fields).
     */
    ...
    /**
     * Create a new BortzAge.
     *
     * @param BortzAgeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BortzAgeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BortzAge|array The created BortzAge as an assoc-array at the
