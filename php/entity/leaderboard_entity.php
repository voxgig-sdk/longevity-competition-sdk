...
// LongevityCompetition SDK Leaderboard entity
...
class LeaderboardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LeaderboardEntity($this->_client, $opts);
    }

    /**
     * @param Leaderboard|array $args Leaderboard data (assoc-array) to store.
     */
    ...
    /**
     * @return Leaderboard|array The current Leaderboard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Leaderboard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Leaderboard fields).
     */
    ...
    /**
     * List Leaderboard items matching the given filter.
     *
     * @param LeaderboardListMatch|array|null $reqmatch Match filter (any subset
     *   of Leaderboard fields) as an assoc-array; LeaderboardListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Leaderboard[]|array A list of Leaderboard items as assoc-arrays at
     *   the SDK boundary; throws LongevityCompetitionError on failure (item-5 convention).
     */
