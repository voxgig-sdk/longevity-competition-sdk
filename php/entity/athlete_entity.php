...
class AthleteEntity
{
     ...
     *
     * @param AthleteListMatch|array|null $reqmatch Match filter (any subset
     *   of Athlete fields) as an assoc-array; AthleteListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Athlete[]|array A list of Athlete items as assoc-arrays at
