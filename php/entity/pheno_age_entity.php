...
// LongevityCompetition SDK PhenoAge entity
...
class PhenoAgeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PhenoAgeEntity($this->_client, $opts);
    }

    /**
     * @param PhenoAge|array $args PhenoAge data (assoc-array) to store.
     */
    ...
    /**
     * @return PhenoAge|array The current PhenoAge data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PhenoAge fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PhenoAge fields).
     */
    ...
    /**
     * Create a new PhenoAge.
     *
     * @param PhenoAgeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PhenoAgeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PhenoAge|array The created PhenoAge as an assoc-array at the
