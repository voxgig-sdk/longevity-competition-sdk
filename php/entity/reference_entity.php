...
// LongevityCompetition SDK Reference entity
...
class ReferenceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReferenceEntity($this->_client, $opts);
    }

    /**
     * @param Reference|array $args Reference data (assoc-array) to store.
     */
    ...
    /**
     * @return Reference|array The current Reference data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Reference fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Reference fields).
     */
    ...
    /**
     * List Reference items matching the given filter.
     *
     * @param ReferenceListMatch|array|null $reqmatch Match filter (any subset
     *   of Reference fields) as an assoc-array; ReferenceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Reference[]|array A list of Reference items as assoc-arrays at
