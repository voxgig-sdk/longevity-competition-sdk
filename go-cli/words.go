...
func registerSDKWords(r *eng.Registry, client *sdk.LongevityCompetitionSDK) {
...
func runOp(client *sdk.LongevityCompetitionSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
