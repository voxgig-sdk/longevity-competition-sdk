...
class AthleteEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LONGEVITYCOMPETITION_TEST_ATHLETE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def athlete_basic_setup(extra)
  ...
  entid_env_raw = ENV["LONGEVITYCOMPETITION_TEST_ATHLETE_ENTID"]
