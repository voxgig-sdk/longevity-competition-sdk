...
class CompetitionEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LONGEVITY_COMPETITION_TEST_COMPETITION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def competition_basic_setup(extra)
  ...
  entid_env_raw = ENV["LONGEVITY_COMPETITION_TEST_COMPETITION_ENTID"]
