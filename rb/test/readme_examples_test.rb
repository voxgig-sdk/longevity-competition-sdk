...
#      offline in seeded test mode (LongevityCompetitionSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "LongevityCompetition_sdk.rb")
  SDK_CLASS = "LongevityCompetitionSDK"
  ...
  SDK_BASE = "LongevityCompetition_sdk"
