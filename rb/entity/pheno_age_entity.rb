...
class PhenoAgeEntity
  ...
  def make
    opts = @_entopts.dup
    PhenoAgeEntity.new(@_client, opts)
  end
  ...
  # @return [PhenoAge, Hash] the current PhenoAge data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PhenoAge fields)
  def match_get
  ...
  #
  # @param reqdata [PhenoAgeCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PhenoAge, Hash] the created PhenoAge; raises LongevityCompetitionError on failure
