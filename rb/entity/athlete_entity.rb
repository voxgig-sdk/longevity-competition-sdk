# LongevityCompetition SDK Athlete entity
...
class AthleteEntity
  ...
  def make
    opts = @_entopts.dup
    AthleteEntity.new(@_client, opts)
  end
  ...
  # @return [Athlete, Hash] the current Athlete data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Athlete fields)
  def match_get
  ...
  # List Athlete items matching the given filter.
  #
  # @param reqmatch [AthleteListMatch, Hash, nil] match filter (any subset of
  #   Athlete fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Athlete>, Array] the matching Athlete items; raises LongevityCompetitionError on failure
