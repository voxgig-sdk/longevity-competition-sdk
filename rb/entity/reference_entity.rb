...
class ReferenceEntity
  ...
  def make
    opts = @_entopts.dup
    ReferenceEntity.new(@_client, opts)
  end
  ...
  # @return [Reference, Hash] the current Reference data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Reference fields)
  def match_get
  ...
  #
  # @param reqmatch [ReferenceListMatch, Hash, nil] match filter (any subset of
  #   Reference fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Reference>, Array] the matching Reference items; raises LongevityCompetitionError on failure
