...
class BortzAgeEntity
  ...
  def make
    opts = @_entopts.dup
    BortzAgeEntity.new(@_client, opts)
  end
  ...
  # @return [BortzAge, Hash] the current BortzAge data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of BortzAge fields)
  def match_get
  ...
  #
  # @param reqdata [BortzAgeCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [BortzAge, Hash] the created BortzAge; raises LongevityCompetitionError on failure
