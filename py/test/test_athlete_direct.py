...
class TestAthleteDirect:
    ...
    def test_should_direct_list_athlete(self):
        setup = _athlete_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-athlete", "live" if setup["live"] else "unit")
        if _skip:
