...
from longevitycompetition_sdk.core.spec import LongevityCompetitionSpec
from longevitycompetition_sdk.core.result import LongevityCompetitionResult
from longevitycompetition_sdk.core.response import LongevityCompetitionResponse
from longevitycompetition_sdk.core.operation import LongevityCompetitionOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return LongevityCompetitionError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = LongevityCompetitionSDK.test(None, None)
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except LongevityCompetitionError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = LongevityCompetitionResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = LongevityCompetitionSDK.test(None, None)
        ...
        class TestInitFeature(LongevityCompetitionBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(LongevityCompetitionBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = LongevityCompetitionSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = LongevityCompetitionSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = LongevityCompetitionSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = LongevityCompetitionSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = LongevityCompetitionOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = LongevityCompetitionSDK.test(None, setup_opts)
