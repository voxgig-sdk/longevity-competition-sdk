# LongevityCompetition SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LongevityCompetitionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LongevityCompetitionSDK(...) and LongevityCompetitionSDK.test(...) become
#      LongevityCompetitionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "longevitycompetition_sdk"
_SDK_CLASS = "LongevityCompetitionSDK"
