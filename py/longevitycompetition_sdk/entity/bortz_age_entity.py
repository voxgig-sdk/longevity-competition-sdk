...
class BortzAgeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BortzAgeEntity(self._client, opts)
    ...
    def create(self, reqdata: BortzAgeCreateData, ctrl=None) -> BortzAge:
        utility = self._utility
