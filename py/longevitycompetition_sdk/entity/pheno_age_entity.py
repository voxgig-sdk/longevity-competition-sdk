...
class PhenoAgeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PhenoAgeEntity(self._client, opts)
    ...
    def create(self, reqdata: PhenoAgeCreateData, ctrl=None) -> PhenoAge:
        utility = self._utility
