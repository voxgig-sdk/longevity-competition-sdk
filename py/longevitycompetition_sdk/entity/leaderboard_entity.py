...
from longevitycompetition_sdk.longevitycompetition_types import (
    Leaderboard,
...
class LeaderboardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LeaderboardEntity(self._client, opts)
    ...
    def match_get(self) -> Leaderboard:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Leaderboard]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Leaderboard().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
