...
class RankPreviewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RankPreviewEntity(self._client, opts)
    ...
    def match_get(self) -> RankPreview:
    ...
    def create(self, reqdata: RankPreviewCreateData, ctrl=None) -> RankPreview:
        utility = self._utility
