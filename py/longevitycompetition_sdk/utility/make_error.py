...
def make_error_util(ctx, err):
    if ctx is None:
        ...
        ctx = LongevityCompetitionContext({}, None)
    ...
    result = ctx.result
    if result is None:
        result = LongevityCompetitionResult({})
    result.ok = False
    ...
    errmsg = ""
    if isinstance(err, LongevityCompetitionError):
        errmsg = err.msg
    ...
    sdk_err = LongevityCompetitionError("", msg, ctx)
