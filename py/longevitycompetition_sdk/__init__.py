...
from longevitycompetition_sdk.utility import register

# Load features
from longevitycompetition_sdk.feature.base_feature import LongevityCompetitionBaseFeature
from longevitycompetition_sdk.features import _has_feature, _make_feature
...
class LongevityCompetitionSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("LongevityCompetitionSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Athlete(self, data=None) -> "AthleteEntity":
        ...
        from longevitycompetition_sdk.entity.athlete_entity import AthleteEntity
    ...
    def BortzAge(self, data=None) -> "BortzAgeEntity":
        ...
        from longevitycompetition_sdk.entity.bortz_age_entity import BortzAgeEntity
    ...
    def Competition(self, data=None) -> "CompetitionEntity":
        ...
        from longevitycompetition_sdk.entity.competition_entity import CompetitionEntity
    ...
    def Leaderboard(self, data=None) -> "LeaderboardEntity":
        ...
        from longevitycompetition_sdk.entity.leaderboard_entity import LeaderboardEntity
    ...
    def PhenoAge(self, data=None) -> "PhenoAgeEntity":
        ...
        from longevitycompetition_sdk.entity.pheno_age_entity import PhenoAgeEntity
    ...
    def RankPreview(self, data=None) -> "RankPreviewEntity":
        ...
        from longevitycompetition_sdk.entity.rank_preview_entity import RankPreviewEntity
    ...
    def Reference(self, data=None) -> "ReferenceEntity":
        ...
        from longevitycompetition_sdk.entity.reference_entity import ReferenceEntity
