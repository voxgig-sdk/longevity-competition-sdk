...
(0, node_test_1.describe)('ReferenceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.LongevityCompetitionSDK({
    ...
    (0, node_test_1.test)('direct-list-reference', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-reference', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.LONGEVITY_COMPETITION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LongevityCompetitionSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['LONGEVITY_COMPETITION_TEST_REFERENCE_ENTID'];
    ...
    const client = new __1.LongevityCompetitionSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ReferenceDirect.test.js.map