...
(0, node_test_1.describe)('AthleteEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        const athlete_ref01_match = {};
        const athlete_ref01_list = (await athlete_ref01_ent.list(athlete_ref01_match)).map((e) => e.data());
    });
});
