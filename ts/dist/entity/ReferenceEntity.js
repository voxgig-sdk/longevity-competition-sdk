...
class ReferenceEntity extends LongevityCompetitionEntityBase_1.LongevityCompetitionEntityBase {
    ...
    make() {
        return new ReferenceEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Reference[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
