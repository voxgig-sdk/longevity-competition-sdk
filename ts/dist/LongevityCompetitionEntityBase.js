...
exports.LongevityCompetitionEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends LongevityCompetitionEntityBase<Advice>`.
class LongevityCompetitionEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.LongevityCompetitionEntityBase = LongevityCompetitionEntityBase;
//# sourceMappingURL=LongevityCompetitionEntityBase.js.map