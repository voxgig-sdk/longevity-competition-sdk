...
| `biomarkers` | `table` | Yes | Blood biomarker values required for Bortz Age calculation |
...
| --- | --- | --- | --- |
| `ageReduction` | `number` | No | Calculated Age Reduction |
| `biomarkers` | `table` | Yes | Blood biomarker values required for Pheno Age calculation |
