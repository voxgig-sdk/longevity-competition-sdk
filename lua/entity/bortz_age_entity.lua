...
local BortzAgeEntity = {}
BortzAgeEntity.__index = BortzAgeEntity


function BortzAgeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BortzAgeEntity)
  self._name = "bortz_age"
  self._client = client
...
function BortzAgeEntity:get_name()
  return self._name
end


function BortzAgeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BortzAgeEntity.new(self._client, opts)
end
...
function BortzAgeEntity:mark_deleted()
  self._deleted = true
end


function BortzAgeEntity:deleted()
  return true == self._deleted
end


function BortzAgeEntity:data_set(args)
  if args ~= nil then
...
function BortzAgeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BortzAgeEntity:match_set(args)
  if args ~= nil then
...
function BortzAgeEntity:match_get()
...
function BortzAgeEntity:stream(action, args, callopts)
...
---@param reqdata BortzAgeCreateData
---@param ctrl? table
---@return BortzAge
---@return string? err
function BortzAgeEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function BortzAgeEntity:_run_op(ctx, post_done)
  local utility = self._utility
