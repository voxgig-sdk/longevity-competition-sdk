...
describe("AthleteDirect", function()
  it("should direct-list-athlete", function()
    local setup = athlete_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-athlete", setup.live and "live" or "unit")
