...
local SDK_MODULE = "longevity-competition_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["athlete"] = { ["test01"] = { id = "test01" } }, ["bortz_age"] = { ["test01"] = { id = "test01" } }, ["competition"] = { ["test01"] = { id = "test01" } }, ["leaderboard"] = { ["test01"] = { id = "test01" } }, ["pheno_age"] = { ["test01"] = { id = "test01" } }, ["rank_preview"] = { ["test01"] = { id = "test01" } }, ["reference"] = { ["test01"] = { id = "test01" } } } }'
