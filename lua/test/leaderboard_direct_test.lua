...
describe("LeaderboardDirect", function()
  it("should direct-list-leaderboard", function()
    local setup = leaderboard_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-leaderboard", setup.live and "live" or "unit")
