...
function runner.env_override(m)
  local live = runner.getenv("LONGEVITYCOMPETITION_TEST_LIVE")
  local override = runner.getenv("LONGEVITYCOMPETITION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LONGEVITYCOMPETITION_TEST_EXPLAIN")
