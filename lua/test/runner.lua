...
function runner.env_override(m)
  local live = runner.getenv("LONGEVITY_COMPETITION_TEST_LIVE")
  local override = runner.getenv("LONGEVITY_COMPETITION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LONGEVITY_COMPETITION_TEST_EXPLAIN")
