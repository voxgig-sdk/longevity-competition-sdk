...
describe("ReferenceDirect", function()
  it("should direct-list-reference", function()
    local setup = reference_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-reference", setup.live and "live" or "unit")
