// Command LongevityCompetition-mcp is an MCP server exposing the LongevityCompetition
// SDK as MCP tools.
//
// Two tools are registered:
//
//	LongevityCompetition_list  — list records of an entity
//	LongevityCompetition_load  — load a single record of an entity
//
