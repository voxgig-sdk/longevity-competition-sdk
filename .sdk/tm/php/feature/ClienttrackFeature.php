...
// LongevityCompetition SDK clienttrack feature
...
class LongevityCompetitionClienttrackFeature extends LongevityCompetitionBaseFeature
{
    ...
    public function PostConstruct(LongevityCompetitionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LongevityCompetition-SDK';
