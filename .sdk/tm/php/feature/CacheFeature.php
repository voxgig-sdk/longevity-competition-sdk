...
// LongevityCompetition SDK cache feature
...
class LongevityCompetitionCacheFeature extends LongevityCompetitionBaseFeature
{
    ...
    private function _through(LongevityCompetitionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
