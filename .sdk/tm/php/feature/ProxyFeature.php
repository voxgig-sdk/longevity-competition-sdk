...
// LongevityCompetition SDK proxy feature
...
class LongevityCompetitionProxyFeature extends LongevityCompetitionBaseFeature
{
    ...
    public function init(LongevityCompetitionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LongevityCompetitionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
