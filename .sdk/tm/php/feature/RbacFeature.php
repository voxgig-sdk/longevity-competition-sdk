...
// LongevityCompetition SDK rbac feature
...
class LongevityCompetitionRbacFeature extends LongevityCompetitionBaseFeature
{
    ...
    private function _required(LongevityCompetitionContext $ctx): ?string
    {
    ...
    private function _reject(LongevityCompetitionContext $ctx, string $required): void
    {
    ...
    private function _track(LongevityCompetitionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
