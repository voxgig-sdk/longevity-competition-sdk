...
// LongevityCompetition SDK audit feature
...
class LongevityCompetitionAuditFeature extends LongevityCompetitionBaseFeature
{
    ...
    private function _emit(LongevityCompetitionContext $ctx, string $outcome): void
    {
