...
// LongevityCompetition SDK netsim feature
...
class LongevityCompetitionNetsimFeature extends LongevityCompetitionBaseFeature
{
    ...
    private function _simulate(LongevityCompetitionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LongevityCompetitionContext $ctx, array $applied): void
    {
        $client = $this->client;
