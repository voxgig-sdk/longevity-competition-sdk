...
// LongevityCompetition SDK utility: make_options

class LongevityCompetitionMakeOptions
{
    ...
    public static function call(LongevityCompetitionContext $ctx): array
    {
        ...
        //
        // `LongevityCompetitionSchema::optspec()` is built from the model:
        ...
        $optspec = LongevityCompetitionSchema::optspec();
