...
// LongevityCompetition SDK utility: fetcher

class LongevityCompetitionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LongevityCompetitionSDK/1.0)';
    ...
    public static function call(LongevityCompetitionContext $ctx, string $fullurl, array $fetchdef): array
    {
