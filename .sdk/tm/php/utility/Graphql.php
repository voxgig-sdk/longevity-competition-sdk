...
// LongevityCompetition SDK utility: graphql
//
...
class LongevityCompetitionGraphql
{
    ...
    // equivalent.
    public static function body(LongevityCompetitionContext $ctx): mixed
    {
    ...
    public static function errors(LongevityCompetitionContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
