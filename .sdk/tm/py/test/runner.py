...
class LongevityCompetitionTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LongevityCompetitionTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LongevityCompetitionTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LongevityCompetitionTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
