# LongevityCompetition SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # LongevityCompetitionSDK.new, not LongevityCompetitionSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    LongevityCompetitionSDK.new(opts)
  end
