...
|---|---|---|
| `ts/` | @voxgig-sdk/longevity-competition-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/longevity-competition-sdk \
      --repository voxgig-sdk/longevity-competition-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/longevity-competition-sdk` shows it, and
`npm trust revoke @voxgig-sdk/longevity-competition-sdk --id=<id>` removes it.
