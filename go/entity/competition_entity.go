...
func NewCompetitionEntity(client *core.LongevityCompetitionSDK, entopts map[string]any) *CompetitionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompetitionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
