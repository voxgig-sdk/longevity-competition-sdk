...
func NewReferenceEntity(client *core.LongevityCompetitionSDK, entopts map[string]any) *ReferenceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReferenceEntity) GetName() string { return e.name }
...
func (e *ReferenceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReferenceEntity) Deleted() bool {
	return e.deleted
}


func (e *ReferenceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReferenceEntity(e.client, opts)
}

func (e *ReferenceEntity) Data(args ...any) any {
...
func (e *ReferenceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Reference; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReferenceEntity) DataTyped(data ...Reference) Reference {
	if len(data) > 0 {
		return typedFrom[Reference](e.Data(asMap(data[0])))
	}
	return typedFrom[Reference](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Reference (all fields
// optional at the wire level).
func (e *ReferenceEntity) MatchTyped(match ...Reference) Reference {
	if len(match) > 0 {
		return typedFrom[Reference](e.Match(asMap(match[0])))
	}
	return typedFrom[Reference](e.Match())
}
...
func (e *ReferenceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReferenceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ReferenceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReferenceListMatch and returns []Reference. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ReferenceEntity) ListTyped(reqmatch ReferenceListMatch, ctrl map[string]any) ([]Reference, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Reference](res), nil
}



func (e *ReferenceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReferenceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReferenceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReferenceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
