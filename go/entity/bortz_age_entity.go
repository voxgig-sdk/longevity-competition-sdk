...
func NewBortzAgeEntity(client *core.LongevityCompetitionSDK, entopts map[string]any) *BortzAgeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BortzAgeEntity) GetName() string { return e.name }
...
func (e *BortzAgeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BortzAgeEntity) Deleted() bool {
	return e.deleted
}


func (e *BortzAgeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBortzAgeEntity(e.client, opts)
}

func (e *BortzAgeEntity) Data(args ...any) any {
...
func (e *BortzAgeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BortzAge; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BortzAgeEntity) DataTyped(data ...BortzAge) BortzAge {
	if len(data) > 0 {
		return typedFrom[BortzAge](e.Data(asMap(data[0])))
	}
	return typedFrom[BortzAge](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BortzAge (all fields
// optional at the wire level).
func (e *BortzAgeEntity) MatchTyped(match ...BortzAge) BortzAge {
	if len(match) > 0 {
		return typedFrom[BortzAge](e.Match(asMap(match[0])))
	}
	return typedFrom[BortzAge](e.Match())
}
...
func (e *BortzAgeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BortzAgeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BortzAgeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BortzAgeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BortzAgeCreateData and returns an BortzAge. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BortzAgeEntity) CreateTyped(reqdata BortzAgeCreateData, ctrl map[string]any) (BortzAge, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return BortzAge{}, err
	}
	return typedFrom[BortzAge](res), nil
}



func (e *BortzAgeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BortzAgeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BortzAgeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
