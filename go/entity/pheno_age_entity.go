...
func NewPhenoAgeEntity(client *core.LongevityCompetitionSDK, entopts map[string]any) *PhenoAgeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PhenoAgeEntity) GetName() string { return e.name }
...
func (e *PhenoAgeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PhenoAgeEntity) Deleted() bool {
	return e.deleted
}


func (e *PhenoAgeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPhenoAgeEntity(e.client, opts)
}

func (e *PhenoAgeEntity) Data(args ...any) any {
...
func (e *PhenoAgeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PhenoAge; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PhenoAgeEntity) DataTyped(data ...PhenoAge) PhenoAge {
	if len(data) > 0 {
		return typedFrom[PhenoAge](e.Data(asMap(data[0])))
	}
	return typedFrom[PhenoAge](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PhenoAge (all fields
// optional at the wire level).
func (e *PhenoAgeEntity) MatchTyped(match ...PhenoAge) PhenoAge {
	if len(match) > 0 {
		return typedFrom[PhenoAge](e.Match(asMap(match[0])))
	}
	return typedFrom[PhenoAge](e.Match())
}
...
func (e *PhenoAgeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PhenoAgeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PhenoAgeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PhenoAgeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PhenoAgeCreateData and returns an PhenoAge. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PhenoAgeEntity) CreateTyped(reqdata PhenoAgeCreateData, ctrl map[string]any) (PhenoAge, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PhenoAge{}, err
	}
	return typedFrom[PhenoAge](res), nil
}



func (e *PhenoAgeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PhenoAgeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PhenoAgeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
