...
func NewAthleteEntity(client *core.LongevityCompetitionSDK, entopts map[string]any) *AthleteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AthleteEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AthleteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AthleteListMatch and returns []Athlete. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AthleteEntity) ListTyped(reqmatch AthleteListMatch, ctrl map[string]any) ([]Athlete, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Athlete](res), nil
}
