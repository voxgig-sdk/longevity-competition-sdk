...
func NewLeaderboardEntity(client *core.LongevityCompetitionSDK, entopts map[string]any) *LeaderboardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LeaderboardEntity) GetName() string { return e.name }
...
func (e *LeaderboardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LeaderboardEntity) Deleted() bool {
	return e.deleted
}


func (e *LeaderboardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLeaderboardEntity(e.client, opts)
}

func (e *LeaderboardEntity) Data(args ...any) any {
...
func (e *LeaderboardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Leaderboard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LeaderboardEntity) DataTyped(data ...Leaderboard) Leaderboard {
	if len(data) > 0 {
		return typedFrom[Leaderboard](e.Data(asMap(data[0])))
	}
	return typedFrom[Leaderboard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Leaderboard (all fields
// optional at the wire level).
func (e *LeaderboardEntity) MatchTyped(match ...Leaderboard) Leaderboard {
	if len(match) > 0 {
		return typedFrom[Leaderboard](e.Match(asMap(match[0])))
	}
	return typedFrom[Leaderboard](e.Match())
}
...
func (e *LeaderboardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LeaderboardEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LeaderboardEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LeaderboardListMatch and returns []Leaderboard. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LeaderboardEntity) ListTyped(reqmatch LeaderboardListMatch, ctrl map[string]any) ([]Leaderboard, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Leaderboard](res), nil
}



func (e *LeaderboardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LeaderboardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LeaderboardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LeaderboardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
