...
type RankPreviewEntity struct {
	name    string
	client  *core.LongevityCompetitionSDK
...
func NewRankPreviewEntity(client *core.LongevityCompetitionSDK, entopts map[string]any) *RankPreviewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RankPreviewEntity) GetName() string { return e.name }
...
func (e *RankPreviewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RankPreviewEntity) Deleted() bool {
	return e.deleted
}


func (e *RankPreviewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRankPreviewEntity(e.client, opts)
}

func (e *RankPreviewEntity) Data(args ...any) any {
...
func (e *RankPreviewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RankPreview; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RankPreviewEntity) DataTyped(data ...RankPreview) RankPreview {
	if len(data) > 0 {
		return typedFrom[RankPreview](e.Data(asMap(data[0])))
	}
	return typedFrom[RankPreview](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RankPreview (all fields
// optional at the wire level).
func (e *RankPreviewEntity) MatchTyped(match ...RankPreview) RankPreview {
	if len(match) > 0 {
		return typedFrom[RankPreview](e.Match(asMap(match[0])))
	}
	return typedFrom[RankPreview](e.Match())
}
...
func (e *RankPreviewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RankPreviewEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RankPreviewEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RankPreviewEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RankPreviewCreateData and returns an RankPreview. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RankPreviewEntity) CreateTyped(reqdata RankPreviewCreateData, ctrl map[string]any) (RankPreview, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return RankPreview{}, err
	}
	return typedFrom[RankPreview](res), nil
}



func (e *RankPreviewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RankPreviewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RankPreviewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
