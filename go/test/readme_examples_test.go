...
const testSeed = `map[string]any{"entity": map[string]any{"athlete": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "bortz_age": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "competition": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "leaderboard": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pheno_age": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rank_preview": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reference": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
