...
func TestAthleteEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set LONGEVITY_COMPETITION_TEST_ATHLETE_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func athleteBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("LONGEVITY_COMPETITION_TEST_ATHLETE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["LONGEVITY_COMPETITION_TEST_ATHLETE_ENTID"])
